                ...
                <div className={Styles.whiteSection}>
                    <div className={Styles.whiteSectionContent}>
                        ...
                        <div key={Math.random()} onAnimationEnd={() => {if(animation == Styles.popOut){setAnimaton(" ")}}} onMouseEnter={() => setAnimaton(Styles.popIn)} onMouseLeave={() => {setAnimaton(Styles.popOut)}} className={[Styles.dropdownContainer, animation].join(" ")}>
                            <Link href='/' className={Styles.dropdownMenuItem}>Ocean Freight</Link>
                            <Link href='/' className={Styles.dropdownMenuItem}>Air Freight</Link>
                            <Link href='/' className={Styles.dropdownMenuItem}>Sea Freight</Link>
                            <Link href='/' className={Styles.dropdownMenuItem}>Clearance</Link>
                        </div>
                    </div>
                </div>
            </div>
